...
- confirmed (≥2 sources, same direction): **12**
- single-source (1 source only):          **47**
- direction conflicts (A↔B):              **3**

## Direction conflicts — require a `force_direction` decision

| meters | source(s) saying A→B | source(s) saying B→A |
|---|---|---|
| `B643.VP1_VMM61` ↔ `B643.VÅ9_VMM42` | `B643.VÅ9_VMM42 → B643.VP1_VMM61` [flow_schema] | `B643.VP1_VMM61 → B643.VÅ9_VMM42` [naming] |
| `B674.VP1_VMM61` ↔ `B674.VÅ9_VMM41` | `B674.VÅ9_VMM41 → B674.VP1_VMM61` [flow_schema] | `B674.VP1_VMM61 → B674.VÅ9_VMM41` [naming] |
| `B674.VP2_VMM61` ↔ `B674.VÅ9_VMM42` | `B674.VÅ9_VMM42 → B674.VP2_VMM61` [flow_schema] | `B674.VP2_VMM61 → B674.VÅ9_VMM42` [naming] |
...
| `B612.VP2_VMM61` | `B612.VP2_VMM62` | flow_schema, naming |
...
| `B833.VP1_VMM61` | `B833.VP1_VMM62` | flow_schema, naming |
| `B833.VP1_VMM61` | `B833.VÅ9_VMM41` | flow_schema, naming |
...
| from | to |
|---|---|
| `B611.VP1_VMM61` | `B611.VÅ9_VMM41` |
| `B611.VP1_VMM61` | `B611.VÅ9_VMM43` |
| `B611.VP2_VMM61` | `B611.VÅ9_VMM41` |
| `B611.VP2_VMM61` | `B611.VÅ9_VMM43` |
| `B611.VÅ9_VMM41` | `B611.VÅ9_VMM43` |
| `B612.VP2_VMM61` | `B612.VÅ9_VMM41` |
| `B612.VP2_VMM62` | `B612.VP2_VMM63` |
| `B612.VP2_VMM63` | `B612.VP2_VMM64` |
| `B612.VP2_VMM64` | `B612.VP2_VMM65` |
| `B613.VP1_VMM61` | `B613.VP1_VMM62` |
| `B614.VS1_VMM61` | `B614.VÅ9_VMM41` |
| `B616.VP1_VMM61` | `B616.VP1_VMM62` |
| `B616.VP1_VMM61` | `B616.VS1_VMM61` |
| `B616.VP1_VMM61` | `B616.VS2_VMM61` |
| `B616.VP1_VMM61` | `B616.VÅ9_VMM41` |
| `B616.VS1_VMM61` | `B616.VÅ9_VMM41` |
| `B621.VP1_VMM61` | `B621.VÅ9_VMM41` |
| `B625.VS1_VMM61` | `B625.VÅ9_VMM41` |
| `B631.VP1_VMM61` | `B631.VP1_VMM62` |
| `B631.VP1_VMM62` | `B631.VP1_VMM63` |
| `B634.VP1_VMM61` | `B634.VÅ9_VMM41` |
| `B643.VP1_VMM61` | `B643.VÅ9_VMM41` |
| `B643.VP2_VMM61` | `B643.VÅ9_VMM41` |
| `B643.VP2_VMM61` | `B643.VÅ9_VMM42` |
| `B643.VÅ9_VMM41` | `B643.VÅ9_VMM42` |
| `B661.VP1_VMM61` | `B661.VS1_VMM61` |
| `B674.VP1_VMM61` | `B674.VÅ9_VMM42` |
| `B674.VP2_VMM61` | `B674.VÅ9_VMM41` |
| `B674.VÅ9_VMM41` | `B674.VÅ9_VMM42` |
| `B821.VP1_VMM61` | `B821.VS1_VMM61` |

### timeseries (1 edges)

| from | to |
|---|---|
| `B613.VP1_VMM61` | `B613.VP2_VMM61` |
